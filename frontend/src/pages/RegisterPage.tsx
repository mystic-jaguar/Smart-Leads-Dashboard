        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className={`w-full rounded-lg border bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition px-3.5 py-2.5 text-sm ${errors.name ? 'border-red-400' : 'border-gray-300 dark:border-gray-600'}`}
              {...register('name')}
            />
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <button type="button" onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" aria-label="Toggle password">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              className={`w-full rounded-lg border bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition px-3.5 py-2.5 text-sm ${errors.role ? 'border-red-400' : 'border-gray-300 dark:border-gray-600'}`}
              {...register('role')}
            >
